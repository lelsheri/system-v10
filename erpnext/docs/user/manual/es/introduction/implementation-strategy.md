...
### Fase de Prueba
  ...
  * Leer el manual
  * Crea una cuenta gratis en [http://revaluesoft.com](http://revaluesoft.com) (La forma más facíl de experimental).
...
Una vez ya estes falimiliarizado con ERPNext, inicia introduciendo la información real!
  ...
  * También puedes configurar una nueva cuenta en [http://revaluesoft.com](http://revaluesoft.com), y usa los 30 días gratis. [Encuentra mas formas de usar ERPNext](/introduction/getting-started-with-erpnext)
  ...
  * Si necesitas ayuda, [puedes pagar por soporte](http://revaluesoft.com/pricing) o [preguntar en el foro de la comunidad](https://discuss.erpnext.com).
