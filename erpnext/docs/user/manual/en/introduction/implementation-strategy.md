...
### Test Phase
  ...
  * Read the Manual
  * Create a free account at [http://www.revaluesoft.com](http://www.revaluesoft.com) (the easiest way to experiment).
...
Once you are familiar with Revalue ERP, start entering your live data!
  ...
  * You can also setup a new account at [http://www,revaluesoft.com](http://www.revaluesoft.com), and use the 30-day free trial. [Find out more ways of deploying Revalue ERP](docs/user/manual/en/introduction/getting-started-with-erpnext)
  ...
  * If you need help, [you can buy support](http://www.revaluesoft.com).
